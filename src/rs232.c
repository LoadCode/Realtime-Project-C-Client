...
void set_blocking (int port, int nbytes)
...
*/
  ...
  Cport[comport_number] = open(comports[comport_number], O_RDWR  );
...
//ioctl(Cport[comport_number], TIOCGSERIAL, &serial);
//serial.flags |=  ASYNC_LOW_LATENCY;
//ioctl(Cport[comport_number], TIOCSSERIAL, &serial);
